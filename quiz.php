...
if (count($all_quiz)) {
    ...
    <th scope="row" style="text-align: center;"><?php echo $quiz->ID ?></th>
      ...
      <td><a href='edit.php?page=mtouch-quiz/quiz.php&amp;action=delete&amp;quiz=<?php echo $quiz->ID?>' class='delete' onclick="return confirm('<?php echo  addslashes(__("You are about to delete this quiz? This will delete all the questions and answers within this quiz. Press 'OK' to delete and 'Cancel' to stop."))?>');">
        <?php _e('Delete')?>
        </a></td>
    </tr>
    <?php
